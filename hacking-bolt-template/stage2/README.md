...
2. In the app, tap **+** and subscribe to a **unique, hard-to-guess topic name**, e.g.
   `mattshifts-a1b2c3` (anyone who knows the topic can see the pushes, so make it random).
...
| Name | Value |
|---|---|
| `LB_USER` | your Lightning Bolt username (`<matt-lightning-bolt-username>`) |
...
LB_USER='<matt-lightning-bolt-username>' LB_PASS='••••••' NTFY_TOPIC='your-topic' node run.mjs
```
