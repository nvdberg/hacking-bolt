...
const NTFY_TOPIC = process.env.NTFY_TOPIC;                       // e.g. "hackingbolt-yourname-a1b2"
...
async function harvestPendingSlots(weekDt){
  ...
  return page.evaluate(()=>{
    ...
    // last-token of the display name, matched the same way on the feed side (handles multi-word surnames)
